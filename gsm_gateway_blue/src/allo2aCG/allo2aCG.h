...
#define G4_CHECK_VPM		0
#define G4_LOADING_FW		1
#define G4_STOP_DMA		2
#define G4_CHECK_TIMING		3
#define G4_CHANGE_LATENCY	4
#define G4_IGNORE_LATENCY	5

#define ALLOG4_GET_REGS	_IOW(DAHDI_CODE, 60, struct g4_regs)
#define ALLOG4_GET_REG	_IOW(DAHDI_CODE, 61, struct g4_reg)
#define ALLOG4_SET_REG	_IOW(DAHDI_CODE, 62, struct g4_reg)
